"""Evaluating Student Writing - Kaggle Challenge file for ensuring the package is executable
as `evaluating-student-writing-kaggle-challenge` and `python -m eswkg`
"""
import importlib
